...
const attacks=[
  ...
  ["vertical reference invalidated",m=>m.coordinate_system.vertical_reference="RH2000","vertical reference invalid"],
  ...
  ["terrain demoted",m=>m.elements.find(x=>x.id==="TERRAIN_CONTEXT").evidence_class="DERIVED","terrain evidence class"],
...
const terrainAttacks=[
  ...
  ["raster acquisition unset",m=>m.raster_access.raster_bytes_acquired=false,"terrain raster acquisition unverified"],
  ["raster values unset",m=>m.raster_access.terrain_values_available=false,"terrain raster acquisition unverified"],
  ["raster hash forged",m=>m.raster_access.data_asset_sha256="0".repeat(64),"terrain raster acquisition unverified"],
  ["raster identity mismatched",m=>m.raster_access.data_asset_byte_count=1,"terrain raster acquisition unverified"],
  ["runtime credential persisted",m=>m.raster_access.runtime_credential_persisted=true,"terrain raster acquisition unverified"],
  ["terrain gate status forged",m=>m.terrain_gate.status="SATISFIED","terrain gate not properly closed"],
  ["terrain gate provenance forged",m=>m.terrain_gate.closure_evidence.provenance_qa_passed=false,"terrain gate not properly closed"],
  ["terrain gate downstream hidden",m=>m.terrain_gate.still_open_downstream=[],"terrain gate not properly closed"],
