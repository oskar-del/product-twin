...
assert.equal(valid.artifacts.length,13);assert.equal(valid.expected_gate_state.publicly_publishable,0);
...
reject("runtime evidence inflation",p=>p.runtime_evidence.views=84,"runtime_inventory");
