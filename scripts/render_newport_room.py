...
MANIFEST = os.path.join(BASE, 'data/showrooms/newport-living-room-furniture-manifest-v0.1.json')
OUT = os.path.join(BASE, '.runtime/renders/newport-living-room-v0.1.png')
