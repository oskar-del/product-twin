...
const showroomComposition = JSON.parse(fs.readFileSync("data/showrooms/svartinge-glanrummet-living-room-v0.3.json", "utf8"));
const commerceHandoff = JSON.parse(fs.readFileSync("data/integration/svartinge-glanrummet-commerce-v0.3.json", "utf8"));
...
check(showroomViewer.includes("svartinge-glanrummet-living-room-v0.3.json"), "showroom consumes the visually revised Svärtinge composition manifest");
...
check(showroomComposition.appearance_profile.roles.coffee_table.surface_color !== "#ffffff", "coffee-table cue cannot wash out as a white placeholder");
check(showroomComposition.placement_overrides.PT_IKEA_LOHALS_30511288.rotation_deg_y === 90, "rug long axis supports the seating group");
...
check(commerceHandoff.visual_qa.publication_gate === "BLOCK_UNTIL_HUMAN_PIXEL_REVIEW", "unreviewed pixels cannot be published");
