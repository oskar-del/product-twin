...
export function validateVisualReconstruction(manifest,{repoRoot=root}={}){
  ...
  const renderings=manifest.renderings??[],specs={VR_SE_SVARTINGE_STREET_ARRIVAL_V01:{viewpoint:"STREET_ARRIVAL_EXISTING_CONDITION",path:"prototype/svartinge-neighbourhood/assets/street-arrival-existing-condition-v0.1.png",hash:"47c0ce69c29659c219f9c12d1cc1be08235a505ed941dad48e801ad0f8ccec13"},VR_SE_SVARTINGE_NEIGHBOURHOOD_AERIAL_V01:{viewpoint:"NEIGHBOURHOOD_AERIAL_EXISTING_CONDITION",path:"prototype/svartinge-neighbourhood/assets/neighbourhood-aerial-existing-condition-v0.1.png",hash:"45b6a7d4332e5359735acb075310423e88f178088917ccc99058cfcbd0891d41"}};check(renderings.length===2,"visual reconstruction set incomplete");
