...
export function validateStreetApproachViewer(html){
  ...
  check(html.includes("plotBeaconLabelRole==='SUBJECT'&&['STREET_VIEW','PLOT_ORBIT'].includes(stage.id)")&&html.includes("if(o.userData.plotAnalyticalCue)o.visible=false"),"street approach plot locator is visually obstructive");
