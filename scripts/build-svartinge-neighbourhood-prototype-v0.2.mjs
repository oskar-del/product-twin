...
function buildScene(){
  ...
  const navigation=[
    ...
    {id:"CONCEPT_HOUSE_ON_PLOT",label:"Design scenario · not selected",camera:[34,24,36],target:[1,2,1],visible_groups:["TERRAIN","PLOT","ROAD","CONTEXT_BUILDING","VIEW_DIRECTION"],cutaway:false},
